#!/usr/bin/env python3
# ============================================================
# CPU-OPTIMIZED Parkinson's EEG - AGGRESSIVE CLASS BALANCE FIX
# Problem: Model only predicts class 1 (PD)
# Solution: Much stronger minority class emphasis + label smoothing
# ============================================================
...
MODEL_SAVE_DIR = r"C:\projects\NCF-lite\test-2\var\models"
...
# ============================================================
# LABEL SMOOTHING CROSS ENTROPY (helps with imbalance)
# ============================================================
...
# ============================================================
# MODEL - SIMPLIFIED for better learning
# ============================================================
...
# ============================================================
# TRAINING - AGGRESSIVE CLASS BALANCE
# ============================================================
def train_one_fold(fold, train_df, val_df, canon_chs, extract_windows_fn,
    ...
    # VERY AGGRESSIVE weighting for minority class
    ...
    # STRONG boost for minority class
    ratio = n1 / max(1, n0)  # ~2.0 for your data
    w0 = ratio * 1.5  # ~3.0x boost for minority
    w1 = 1.0
    ...
    model = NeuroConvFormerLite(n_ch=n_ch, n_time=n_time, d_model=56, n_heads=4, n_layers=2, dropout=0.25).to(DEVICE)
    ...
    # STRONG class weights in loss
    w0_ce = ratio * 2.0  # ~4.0x for minority class
    w1_ce = 1.0
    ...
    # Label smoothing CE with strong class weights
    crit = LabelSmoothingCrossEntropy(weight=class_w, smoothing=0.1)
