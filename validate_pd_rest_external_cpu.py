...
# Laptop-safe, UI-safe, research-correct
# ============================================================

# ------------------------------------------------------------
# CRITICAL: LIMIT CPU THREADS (DO THIS FIRST)
# ------------------------------------------------------------
import os
...
DEVICE = "cpu"  # FORCE CPU (important on Iris)

WIN_SEC = 10.0
OVERLAP = 0.5
TRAIN_CHANNELS = 60        # from ds004584
BATCH_SIZE = 8             # safe for laptop
MAX_WINDOWS = 200          # cap per subject (remove for overnight runs)
...
# ============================================================
# SUBJECT-WISE VALIDATION (STREAMING)
# ============================================================
print("\nSubject | Mean PD Prob | Std | Windows")
print("-" * 45)

for fp in tqdm(files, desc="Validating subjects"):
...
print("\n[INFO] CPU-optimized external validation completed successfully.")
